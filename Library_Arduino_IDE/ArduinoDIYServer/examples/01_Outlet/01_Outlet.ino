...
/*
  ...
  {"Name":"outlet","Configured Name":"outlet","On":"0","Outlet In Use":"0"}
...
const char* OTA_HOSTNAME = "outlet-device";
...
void loop() {
  ...
  if (millis() - lastPollMs >= POLL_INTERVAL_MS) {
    ...
    pollVpinFromServer(VPIN_OUTLET);
    ...
    // Update the JSON document before sending it back.
    doc["Outlet In Use"] = doc["On"];

    updateVpinOnServer(VPIN_OUTLET);
  }
}
